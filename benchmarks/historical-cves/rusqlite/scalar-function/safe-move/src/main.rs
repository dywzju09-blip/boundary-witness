...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let runtime = benchmark_runtime("run:scalar:0261-safe-move", "trace:scalar:0261-safe-move")?;
    runtime.emit_trace_start(benchmark_build_id("build:scalar:0261-safe-move"))?;
