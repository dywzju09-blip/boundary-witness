...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let runtime = benchmark_runtime("run:update:0261-no-trigger", "trace:update:0261-no-trigger")?;
    runtime.emit_trace_start(benchmark_build_id("build:update:0261-no-trigger"))?;
