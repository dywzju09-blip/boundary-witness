...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let runtime = benchmark_runtime("run:update:0261-safe-move", "trace:update:0261-safe-move")?;
    runtime.emit_trace_start(benchmark_build_id("build:update:0261-safe-move"))?;
