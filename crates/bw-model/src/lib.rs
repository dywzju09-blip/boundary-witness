...
pub use lifecycle_v326::{
    ...
    V326ContractRelease, V326ContractReplacement, V326ContractRetention, V326CoverageGap,
    V326CoverageGapReason, V326CoverageState, V326Distinguishability, V326EvidenceConfidence,
    V326EvidenceKind, V326FeatureSet, V326ForeignOwnerSemantics, V326LifecycleContractRecord,
