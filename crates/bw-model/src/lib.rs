...
pub use contract::{
    ...
    OpaqueHandleIdentityComponent, ReleaseBehavior,
};
pub use corpus::{
...
pub use lifecycle_v326::{
    ...
    V326AnonymousPairRecord, V326AnonymousPairSummary, V326ContractRelease,
    V326ContractReplacement, V326ContractRetention, V326CoverageGap, V326CoverageGapReason,
    V326CoverageState, V326Distinguishability, V326EvidenceConfidence, V326EvidenceKind,
    ...
    V326WitnessAction, V326WitnessActionKind, V326WitnessApiCrate, V326WitnessObservedShape,
    V326WitnessPlanRecord, V326WitnessPlanSummary, V326WitnessRoute, V326WitnessTarget,
    active_feature_names, build_v3_2_6_lifecycle_graph, build_v3_2_6_lifecycle_graph_v3,
    compare_v3_2_6_pair, derive_v3_2_6_lifecycle_features,
