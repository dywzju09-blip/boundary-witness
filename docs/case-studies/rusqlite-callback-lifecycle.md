...
- 历史 D1 formal：`unix1784400047-f3fa5ed-d1formal` 为 30/30 primary、每个 20/20 replay；第二 API smoke 为 3/3（旧路线记录已归档，不在当前 results 索引）。
- 历史 M12 blind gate：10/10 completed、2 个 confirmed case 各 20/20 replay、controls clean（同上，已归档）。
